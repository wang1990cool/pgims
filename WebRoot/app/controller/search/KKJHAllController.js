Ext.define('App.controller.search.KKJHAllController', {
			extend : 'Ext.app.Controller',

			models : ['jxkkjh.KKJHModel','jxkkjh.KKJHMXModel','main.PageModel','audit.AuditDetailModel'],
			stores : ['jxkkjh.KKJHStore','jxkkjh.KKJHTGStore',
				'zd.ZdXqbStore','main.PageStore','audit.AuditDetailStore'],
//			view:['jxkkjh.KKJHAllContentPanel'],
	...
	detailKKJH:function(o, e, eOpts){ 
        	...
        	var controller = application.getController('App.controller.search.KKJHDetailController');
	 ...
	 auditDetail:function(o,e,eOpts){
	  	...
	  	var recs = o.ownerCt.ownerCt.getSelectionModel().getSelection();
			...
			onLaunch : function(record) {
				...
				var contentPanel = Ext.create('App.view.search.KKJHAllContentPanel',
						{
							itemId : 'content',
