Ext.define('App.controller.skzl.SKZLController', {
			...
			init : function() {
				this.control({
							'skzlList combo[itemId=numCmb]': {
								render: this.initPageSize,
								select: this.setPageSize
							},
						  'skzlList button[itemId=schShowBtn]' : {
							render : this.setSchShowText
						   },
						   'skzlList button[action=showSearch]' : {
							      click : this.showSearch
							},
							'skzlList  button[action=detail]':{
								click: this.detailSkzl
							},
							'skzlList  button[action=upload]':{
								click : this.uploadSkzl
							},
							'skzlList  button[action=ok]':{
								click: this.okSkzl
							},
							'skzlList  button[action=delete]':{
								click: this.deleteSkzl
							},
							'skzlList  button[action=verify]':{
								click: this.verifySkzl
							},
							'skzlList  button[action=withdraw]':{
								click: this.withdrawSkzl
							},
	    ...
	    uploadSkzl:function(o, e, eOpts){
		 ...
		 excelBtnRender: function(o, e, eOpts){
			...
			onLaunch : function(record) {
				...
				var contentPanel = Ext.create('App.view.skzl.SKZLContentPanel',
						{
							itemId : 'content',
