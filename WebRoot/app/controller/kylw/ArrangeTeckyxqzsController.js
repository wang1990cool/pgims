Ext.define('App.controller.kylw.ArrangeTeckyxqzsController',{
...
//					    }  
  		...
  		/*detailJs:function(o, e, eOpts){
			...
			onLaunch : function(o,skxxList,kyuuid) {
				...
				var win = Ext.create('App.view.kylw.ArrangeTeckyxqzsWindow',{
						skxxList:skxxList,
						kyuuid:kyuuid,
						x : 300,
						y : 3,
...
//				win.down('#arrangeTecshForm').loadForm(recs[0])
				win.down('#arrangeTecshkyForm').loadForm(recs[0])
				win.down('#arrangeTecjbForm').loadForm(recs[0])
				win.down('#arrangeTecshkyForm').setViewdForm();
