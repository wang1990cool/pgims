Ext.define('App.controller.kyjl.ArrangeTecjlzsController',{
...
//    }],
	...
	init:function(){
		this.control({
				...
				'#arrangeTecWindowjlbjlzs  button[action=save]':{
					click:this.addJs
				}
			});
		},
		addJs:function(o, e, eOpts){
			...
			var kkjhAddJLForm = win.down('#kkjhAddJLzsForm');
			var arrangeTecshzsForm = kkjhAddJLForm.down('#arrangeTecshzsForm');//审核
			var arrangeTecshjlzsForm = kkjhAddJLForm.down('#arrangeTecshjlzsForm');//科研
			...
			var xwKtbgsqb2 = arrangeTecshjlzsForm.down('#viewXwDbmsb1');
			var json = {}
...
//					    }  
  		...
  		/*detailJs:function(o, e, eOpts){
			...
			onLaunch : function(o,skxxList,kyuuid) {
				...
				var win = Ext.create('App.view.kyjl.ArrangeTecjlzsWindow',{
						skxxList:skxxList,
						kyuuid:kyuuid,
						x : 300,
						y : 3,
...
//				win.down('#arrangeTecshForm').loadForm(recs[0])
				win.down('#arrangeTecshjlzsForm').loadForm(recs[0])
				win.down('#arrangeTecjbForm').loadForm(recs[0])
				win.down('#arrangeTecshjlzsForm').setViewdForm();
