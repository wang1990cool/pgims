Ext.define('App.controller.kyzl.ArrangeTecZlController',{
...
//    }],
	...
	init:function(){
		this.control({
				...
				'#arrangeTecWindowjlbb  button[action=save]':{
					click:this.addJs
				}
			});
		},
		addJs:function(o, e, eOpts){
			...
			var kkjhAddZLForm = win.down('#kkjhAddZLForm');
			var arrangeTecshForm = kkjhAddZLForm.down('#arrangeTecshForm');//审核
			var arrangeTecshzlForm = kkjhAddZLForm.down('#arrangeTecshzlForm');//科研
			...
			var xwKtbgsqb2 = arrangeTecshzlForm.down('#viewXwDbmsb1');
			var json = {}
...
//					    }  
  		...
  		/*detailJs:function(o, e, eOpts){
			...
			onLaunch : function(o,skxxList,kyuuid) {
				...
				var win = Ext.create('App.view.kyzl.ArrangeTeczlWindow',{
						skxxList:skxxList,
						kyuuid:kyuuid,
						x : 300,
						y : 3,
