Ext.define('App.view.kttjshcx.ViewXwKtbgzlzbSearchForm', {
	extend : 'Ext.form.Panel',
	alias : 'widget.viewXwKtbgzlzbSearchForm',
	title : '查询条件',
	autoWidth : true,
	bodyPadding : 5,
	layout : 'form',
...
//					maxValue : Ext.util.Format.date(Ext.Date.add(new Date(),Ext.Date.MONTH,0),"Y-m-d")
		        },*/{ 
		        	xtype: 'combo',
		            itemId: 'xn',
		            name: 'xn',
