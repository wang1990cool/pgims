Ext.define('App.view.kyjl.XwKyjlzlbList',{
	extend: 'Ext.grid.Panel',
	store:'XwKyjlzlbStore',
	columnLines: true,
	alias: 'widget.xwKyjlzlbList',
    loadMask: true,
    viewConfig: { 
   		 stripeRows: true 
    },
...
//				            			url: 'xwKyjlzlbFileDownloadJl.action'
//				            		});
//			            		}
		             	case 'zlpreview':{
...
//	             	    	window.open("http://" + "10.100.99.82:8080/pgimsst" + "/" +zlwjdz)
			...
			columns: [Ext.create('Ext.grid.RowNumberer'),
			      ...
			      { text: '文件名称', width: 230, sortable: false, dataIndex: 'zlwjmc',flex: 1},
			      ...
			      { text: '上传时间', /*flex: 1,*/width: 150, sortable: false, dataIndex: 'zlscsj',renderer: function (value, cellmeta, record, rowIndex, columnIndex, store) {
	          	   ...
	          	   {text:'操作',width:150,sortable:false,
