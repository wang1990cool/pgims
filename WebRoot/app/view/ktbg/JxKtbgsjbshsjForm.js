Ext.define('App.view.ktbg.JxKtbgsjbshsjForm', {
    extend: 'Ext.form.Panel',
    alias: 'widget.jxKtbgsjbshsjForm',
    itemId:'jxKtbgsjbshsjForm',
...
//		        	this.up('window').hide();
	...
	loadEditJxKtbgsjbValue:function(rec){
		var me = this;
		var fs = me.down('#jxKtbgsjb');
	...
	xsSubmit: function (){
		var me = this;
		var xwKtbgsqb = me.down('#jxKtbgsjb1'); 
		var json = {}
...
//		alert(Ext.encode(json))
		...
		json['xq'] = xwKtbgsqb.down('#xq').getValue();
		json['xn'] = xwKtbgsqb.down('#xn').getValue();
		json['fyh'] = xwKtbgsqb.down('#fyh').getValue();
		json['fymc'] = xwKtbgsqb.down('#fymc').getValue();
		json['zydm'] = xwKtbgsqb.down('#zydm').getValue();
		json['zymc'] = xwKtbgsqb.down('#zymc').getValue();
		json['xslxm'] = xwKtbgsqb.down('#xslxm').getValue();
		json['xslx'] = xwKtbgsqb.down('#xslx').getValue();
		json['kssj'] = xwKtbgsqb.down('#kssj').getValue();
		json['jssj'] = xwKtbgsqb.down('#jssj').getValue();
		json['bz'] = xwKtbgsqb.down('#bz').getValue();
		json['sznj'] = xwKtbgsqb.down('#sznj').getValue();	
		json['xwbz'] = xwKtbgsqb.down('#xwbz').getValue();	
		    Ext.Ajax.request({
				url : 'jxKtbgsjbEdit.action',
				waitTitle : '提示',
				actionMethods : 'post',
...
//					    	 	 skxxList.getStore().load()
				         ...
				         var jxKtbgsjbList = Ext.ComponentQuery.query('#jxKtbgsjbList');
							 if(jxKtbgsjbList.length > 0) {
								 var jxKtbgsjbList = jxKtbgsjbList[0];
