Ext.define('App.view.jxpk.TreeCombo', {
...
//		me.callback();
    ...
    loadTree: function(node,arr){
    	...
    	if(node){
        	if(me.contains(arr,node.get('id')))
...
//   		var form = me.pkForm;
//   		var kczs = me.getValue();
//   		var jsbh = form.down('#jsbh').getValue();
//   		if(jsbh.length != 0)
//	   		me.getOccupied(form,kczs)
    },
    ...
    getOccupied:function(form,kczs){
    	var me = this;
    	var pkWin = form.up('window');
    	...
    	var jsbh = form.down('#jsbh').getValue();
  		Ext.Ajax.request({
			...
			method:'post',
			params:{kczs:kczs,jsbh:jsbh,xn:xn,xq:xq},
