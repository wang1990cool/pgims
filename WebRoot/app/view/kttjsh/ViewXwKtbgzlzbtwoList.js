Ext.define('App.view.kttjsh.ViewXwKtbgzlzbtwoList', {
	extend: 'Ext.grid.Panel',
	alias: 'widget.viewXwKtbgzlzbList',
...
//  autoScroll:true,
	...
	initComponent: function() {
        ...
        var exportCols = {
        	...
        	,xslxm:'学生类型码',yxsh:'学院代号',zydm:'专业码',xwlbm:'学位类型码',dsh:'导师工号',dsxm:'导师姓名'
        ...
        Ext.applyIf(me, {
            ...
            columns: [
                ...
                { text: exportCols['fymc'], width: 115, dataIndex: 'fymc', sortable: false },
                { text: exportCols['zymc'], width: 115, dataIndex: 'zymc', sortable: false,hidden:false },
                ...
                { text: exportCols['ktrq'], width: 90, dataIndex: 'ktrq', sortable: true },
    	        { text: exportCols['ktdd'], width: 85, dataIndex: 'ktdd', sortable: false},
    	        { text: exportCols['dsh'], width: 85, dataIndex: 'dsh', sortable: false,hidden:true },
                ...
                { text: exportCols['shzt'], width: 85, dataIndex: 'shzt', sortable: true, renderer: function (value, cellmeta, record, rowIndex, columnIndex, store) 
                	{
                		if(value == '审核通过'){
