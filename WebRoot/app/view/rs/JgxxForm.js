Ext.define('App.view.rs.JgxxForm',{
		...
		Ext.applyIf(me, {
			items: [{
				...
				items:[{
					...
					itemId : 'xm',
					name : 'xm',
					fieldLabel : '<font color="red">*</font>教师姓名',
					allowBlank : false,
					blankText : '必填！'
				},{
					xtype : 'textfield',
					itemId : 'gh',
					name : 'gh',
					fieldLabel : '<font color="red">*</font>教师工号',
					allowBlank : false,
					blankText : '必填！',
					listeners:{
							blur:function(){
				    ...
				    itemId : 'szdwh',
				    name : 'szdwh',
				    fieldLabel : '<font color="red">*</font>所在单位',
				   ...
				   listeners:{
					...
					itemId : 'zcm',
					name : 'zcm',
					fieldLabel : '<font color="red">*</font>职称(码)',
					hidden:true
				},{
					xtype : 'combo',
				    itemId : 'zc',
				    name : 'zc',
				    fieldLabel : '<font color="red">*</font>职称',
				    matchFieldWidth:false,
				    allowBlank : false,
					blankText : '必填！',
				    editable : false,
				   ...
				   listeners:{
				   	select:function(combo, record, index){
				   		me.down('#zcm').setValue(record[0].data.bm);
				   	}
				   }
				},{
					xtype : 'combo',
				    itemId : 'zzmmm',
				    name : 'zzmmm',
				    fieldLabel : '<font color="red">*</font>政治面貌',
				    allowBlank : false,
					blankText : '必填！',
				    editable : false,
				    queryMode : 'local',
				...
				items:[{
				    ...
				    itemId : 'zjlxm',
				    name : 'zjlxm',
				    fieldLabel : '<font color="red">*</font>身份证类型',
				    allowBlank : false,
					blankText : '必填！',
				    editable : false,
				    queryMode : 'local',
...
//					regexText:"证件号码格式有误",
				   ...
				   listeners:{
				    ...
				    tpl:'<tpl for=".">' +  
					 ...
					 listeners:{
					   	select:function(combo, record, index){
					   		me.down('#jslym').setValue(record[0].data.jslym);
					   	}
					  }
				},{
					xtype : 'datefield',
...
//					blankText : '必填！',
				   ...
				   listeners:{
				    ...
				    valueField : 'dsztm',
				    tpl:'<tpl for=".">' +  
				            '<div class="x-boundlist-item">' +  '{dszt}'+ 
				      	   '</div>'+
				        '</tpl>',
					 store:Ext.create('Ext.data.Store',{
				        	autoLoad:true,      
