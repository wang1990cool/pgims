Ext.define('App.view.search.XsxxForm', {
...
//					forceSelection : true,
					...
					listeners:{
					   	select:function(combo, record, index){
					   		var me = this;
					   		var XsxxForm = me.up('#xsxxForm')
					   		XsxxForm.down('#mz').setValue(record[0].data.mzmc);
					   	}
					   }
	    		},{
	    			xtype: 'hiddenfield',
...
//					forceSelection : true,
					...
					listeners:{
							   	select:function(combo, record, index){
							   		var me = this;
							   		var XsxxForm = me.up('#xsxxForm')
							   		XsxxForm.down('#zjlx').setValue(record[0].data.sfzjlx);
							   	}
							   }
				...
				},
				{
                    ...
                    listeners:{
						select:function(combo, record, index){
										var me = this;
										var XsxxForm = me.up('#xsxxForm');
										XsxxForm.down('#zzmm').setValue(record[0].data.zzmm);
						}
					}
	    		},
	    		{
				    ...
				    store: 'ZdHyzkmStore',
               	    listeners:{
						select:function(combo, record, index){
								var me = this;
							    var XsxxForm = me.up('#xsxxForm')
							    XsxxForm.down('#hyzk').setValue(record[0].data.hyzk);
							  }
				}
    		},
	    		{
				...
				},
				{
					...
					listeners:{
						   	select:function(combo, record, index){
						   		var me = this;
						   		var XsxxForm = me.up('#xsxxForm')
						   		XsxxForm.down('#xslx').setValue(record[0].data.xslx);
						   	}
				   }
	    		...
	    		},
				{
					...
					listeners:{
								   	select:function(combo, record, index){
								   		var me = this;
								   		var XsxxForm = me.up('#xsxxForm')
								   		XsxxForm.down('#rxfs').setValue(record[0].data.rxfs);
								   	}
					}
	    		...
	    		},
	    		{
					...
					listeners:{
								   	select:function(combo, record, index){
								   		var me = this;
								   		var XsxxForm = me.up('#xsxxForm')
								   		XsxxForm.down('#jylb').setValue(record[0].data.jylb);
								   	}
				   }
	    		...
	    		},
	    		{
                    ...
                    listeners:{
							   	select:function(combo, record, index){
							   		var me = this;
							   		var XsxxForm = me.up('#xsxxForm')
							   		XsxxForm.down('#xwlb').setValue(record[0].data.xwlb);
							   	}
			    	 }
	    		},	
	    		{
	    		...
	    		},
				{
					...
					listeners:{
								   	select:function(combo, record, index){
								   		var me = this;
								   		var XsxxForm = me.up('#xsxxForm')
								   		XsxxForm.down('#pycc').setValue(record[0].data.pycc);
								   	}
				   }
	    		...
	    		},
	    		{
					...
					listeners:{
							   	select:function(combo, record, index){
							   		var me = this;
							   		var XsxxForm = me.up('#xsxxForm')
							   		XsxxForm.down('#yxmc').setValue(record[0].data.yxmc);
							   	}
							   }
	    		},
	    		{
				...
				},			
				{
					...
					listeners:{
						   	select:function(combo, record, index){
						   		var me = this;
						   		var XsxxForm = me.up('#xsxxForm')
						   		XsxxForm.down('#dqzt').setValue(record[0].data.xsdqzt);
						   	}
				   }
	    		...
	    		},
				{
					...
					listeners:{
					   		...
					   		var me = this;
					   		var XsxxForm = me.up('#xsxxForm')
					   		XsxxForm.down('#sfbdm').setValue(record[0].data.sfbdm);
								   	}
								   }
	    		},
	    		{
	    		...
	    		{	    			
					...
					listeners:{
						   	select:function(combo, record, index){
						   		var me = this;
						   		var XsxxForm = me.up('#xsxxForm')
						   		XsxxForm.down('#sfzxm').setValue(record[0].data.sfzxm);
						   	}
				   }
	    		},{
	    			xtype : 'hiddenfield',
