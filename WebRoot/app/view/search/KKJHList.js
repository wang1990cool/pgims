Ext.define('App.view.search.KKJHList',{
	extend: 'Ext.grid.Panel',
	alias: 'widget.kkjhAllList',
	store: 'KKJHStore',
	columnLines: true,
    autoHeight: true,
    autoWidth: true,
...
//	 }
    ...
    initComponent:function(){
    	...
    	var exportCols = {
    		...
    		ztm:'状态码',zt:'状态',bzrgh:'编制人工号',bzr:'编制人'
    	};
...
//    			{text:exportCols['ztm'], width:70, dataIndex:'ztm',hidden:true, sortable: true},
    			{text:exportCols['zt'], width:70, dataIndex:'zt', sortable: true,flex:1}
    		],
