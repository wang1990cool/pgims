Ext.define('App.view.search.ZqkhAllSearchForm',{
	extend:'Ext.form.Panel',
	alias:'widget.zqkhAllSearchForm',
	title:'查询条件',
	autoWidth : true,
	bodyPadding : 5,
	layout : 'form',
    initComponent: function() {
        ...
        Ext.applyIf(me,{
        	items:[{
					...
					labelWidth:80,
					 tpl:'<tpl for=".">' +  
			            '<div class="x-boundlist-item">' +  '{sznj}'+ 
			      	   '</div>'+
			        '</tpl>',
				...
				labelWidth:80
	            	...
	            	listeners:{
    	   				  select: function(combo, nv, ov){
		                            var xqCombo = me.down('#xq');
		                            xqCombo.clearValue();
		                            xqCombo.getStore().load();
	                        }
						},
		            store:Ext.create('Ext.data.Store',{
		            autoLoad: true,
