Ext.define('App.view.skxx.FGgkSkxxmxDetailForm',{
	extend:'Ext.form.Panel',
	alias : 'widget.fGgkSkxxmxDetailForm',
	xtype : 'form',
	itemId: 'fGgkSkxxmxDetailForm',
		...
		items:[{
			...
			layout:{
				...
				tableAttrs:{ 
				 ...
				 tdAttrs:{
						align:'left',
						style:"border: 0px solid rgb(179, 208, 238);"
				}
			},
				  items:[{
							xtype:'textfield',
				...
				tableAttrs:{ 
				 ...
				 tdAttrs:{
				  ...
				  items:[{
						...
						listeners:{
							blur:function(){
								var llxsValue = Number(me.down('#llxs').getValue());
								var syxsValue = Number(this.getValue());
								var zxsValue = syxsValue + llxsValue
								me.down('#zxs').setValue(zxsValue);
							}
						}
