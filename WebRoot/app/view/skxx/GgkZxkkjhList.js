Ext.define('App.view.skxx.GgkZxkkjhList',{
	extend: 'Ext.grid.Panel',
	alias: 'widget.ggkZxkkjhList',
...
//    			{text: exportCols['id'], width: 50,hidden:true, dataIndex: 'id', sortable: true},
    			{text:exportCols['kkjhh'], width:150, dataIndex:'kkjhh', sortable: true},
    			...
    			{text:exportCols['kcxslx'], width:100, dataIndex:'kcxslx', sortable: true},
