Ext.define('App.view.skxx.ViewFSkxxmxList',{
	extend: 'Ext.grid.Panel',
	alias: 'widget.viewFSkxxmxList',
	store: 'ViewFSkxxmxStore',
	columnLines: true,
    autoHeight: true,
    autoWidth: true,
    layout:'auto',
    ...
    initComponent:function(){
    	...
    	var exportCols = {
    		...
    		xslx:'学时类型',xkzym:'学科专业码',xkzy:'学科专业',mzxs:'每周学时',
...
//    			{text: exportCols['id'], width: 50,hidden:true, dataIndex: 'id', sortable: true},
    			{text:exportCols['kkjhh'], width:80, dataIndex:'kkjhh', sortable: true},
    			{text:exportCols['kch'],width:80,dataIndex:'kch',sortable:true,hidden:true},
    			...
    			{text:exportCols['xn'], width:60, dataIndex:'xn', sortable: true},
