Ext.define('App.view.kylw.XwKylwzlbList',{
	extend: 'Ext.grid.Panel',
	store:'XwKylwzlbStore',
	columnLines: true,
	alias: 'widget.xwKylwzlbList',
    loadMask: true,
    viewConfig: { 
   		 stripeRows: true 
    },
...
////		             	    	window.open(zlwjdz)
//		             	    	window.open("http://" + "10.100.99.88:8081/pgimsst" + "/" +zlwjdz)
//			             	    	
//		             	    	break;
//		             	    }
//		             		case 'zldownload':{
...
////				            			url: 'xwKylwzlbFileDownloadKy.action'
//				            			url: 'http://10.100.99.88:8081/pgimsst/xwKylwzlbFileDownloadKy.action'
//				            		});
//			            		}
		             	case 'zlpreview':{
