Ext.define('App.view.kyxxck.XwKyzlbList', {
	extend: 'Ext.grid.Panel',
//	alias: 'widget.viewXwDbmsbList',
	
	store: 'ViewXwKyzlbCKStore',
    columnLines: true,
    title: '科研专利信息',
//  autoScroll:true,
    layout:'auto',
        ...
        Ext.applyIf(me, {
            ...
            columns: [
               { text: exportCols['id'], width: 100, dataIndex: 'id', sortable: true,hidden:true },
                { text: exportCols['xh'], width: 50, dataIndex: 'xh', sortable: true,hidden:true },
                { text: exportCols['xm'], width: 65, dataIndex: 'xm', sortable: true},
                { text: exportCols['cglx'], width: 50, dataIndex: 'cglx', sortable: false ,hidden:true},
                { text: exportCols['fmlx'], width: 100, dataIndex: 'fmlx', sortable: false},
                { text: exportCols['zlmc'], width: 200, dataIndex: 'zlmc', sortable: false},
