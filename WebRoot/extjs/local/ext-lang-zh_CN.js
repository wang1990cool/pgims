...
Ext.define("Ext.locale.zh_CN.grid.filter.BooleanFilter", {
    override: "Ext.ux.grid.filter.BooleanFilter",
	yesText  : "是",
	noText : "否"   
});

Ext.define("Ext.locale.zh_CN.grid.filter.DateFilter", {
...
////js正则表达式实现Array的Contains方法
//Array.prototype.contains = function(item){
//  return RegExp("\\b"+item+"\\b").test(this);
//};

//js正则表达式实现String的Trim方法
String.prototype.Trim = function(){ 
	return this.replace(/(^\s*)|(\s*$)/g, ""); 
};
//js正则表达式实现String的LTrim方法
String.prototype.LTrim = function(){ 
	return this.replace(/(^\s*)/g, ""); 
};
//js正则表达式实现String的RTrim方法
