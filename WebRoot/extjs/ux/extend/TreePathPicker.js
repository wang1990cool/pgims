 ...
 */
Ext.define('Ext.ux.extend.TreePathPicker', {
    ...
    setValue: function(value) {
        ...
        var text = record ?record.getPath(me.displayField,''):'';
        var bIndex = text.indexOf('/',2);
        me.setRawValue(text.substr(bIndex + 1).replace(/\//g,'|'));
...
//    getSubmitData: function() {  //针对treepicker组件的值为其显示的文本内容，而并非其内部代表的value的值的方法
//        var me = this,
//            data = null;
