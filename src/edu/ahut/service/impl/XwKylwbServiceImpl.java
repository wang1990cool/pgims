...
import edu.ahut.model.XwKylwb;
import edu.ahut.service.XwKylwbService;

public class XwKylwbServiceImpl implements XwKylwbService{

	private BaseDAO<XwKylwb,String> xwKylwbDao;
	
	public BaseDAO<XwKylwb, String> getXwKylwbDao() {
		return xwKylwbDao;
	}

	public void setXwKylwbDao(BaseDAO<XwKylwb, String> xwKylwbDao) {
		this.xwKylwbDao = xwKylwbDao;
	}

	
	public boolean add(XwKylwb instance) {
		try {
			xwKylwbDao.save(instance);
		} catch (Exception e) {
			return false;
		}
		return true;
	...
	public boolean deleteByIds(String ids){
		...
		return this.xwKylwbDao.hqlExcute(hql);
	}
	public boolean delete(XwKylwb instance){
		try {
			xwKylwbDao.delete(instance);
		} catch (Exception e) {
			return false;
		}
		return true;
	...
	public boolean update(XwKylwb instance){
		try {
			xwKylwbDao.merge(instance);
		} catch (Exception e) {
			return false;
		}
		return true;
	...
	public List<XwKylwb> Query(String filters, String orders, Object... values){
		String hql = "from XwKylwb as model";
		...
		return xwKylwbDao.hqlQuery(hql, values);
	}
	
	public Page<XwKylwb> pageQuery(int startNo, int pageSize,String filters, String orders, Object... values){
		String hql = "from XwKylwb as model";
		...
		return xwKylwbDao.pagedQueryByStartNo(hql, startNo, pageSize,values);
	}
	
	public List<?> getAll(){
		return xwKylwbDao.getAll();
	}

//	public boolean hqlExcute(String hql, Object...values){
//		return xwKylwbDao.hqlExecute(hql, values);
//	}
	
	public List<XwKylwb> hqlQuery(String hql, Object...values){
		return xwKylwbDao.hqlQuery(hql, values);
	}
...
//	     try{
//	    	 XwKylwb billInstance =  xwKylwbDao.find("from XwKylwb as model where sznj='" + sznj + "'and xn='" + xn + "'"
//	    	 		+ "and xq='" + xq + "'and fyh='" + fyh + "'and zydm='" + zydm + "'"
//	    	 				+ "and xslxm='" + xslxm + "'").get(0);
//	    	billInstance.setSfyx(sfyx);
////	    	billInstance.setZt(zt);
//	    	xwKylwbDao.merge(billInstance);
//	     }catch(Exception e){
//	    	 e.printStackTrace();
//	    	 return false;
//	     }
...
//	}
	...
	public Boolean changeFlowFlag(String xh,String kyuuid,String ztm,String zt,String shrgh,String shr,Date shsj,String shyj
	     ...
	     try{
	    	 XwKylwb billInstance = xwKylwbDao.find("from XwKylwb as model where xh='" + xh + "'and "
	    	 		+ "kyuuid='" + kyuuid + "'").get(0);
...
public String getKyuuid(String KYUUID) {
	String hql = "from XwKylwb as model where model.kyuuid like '" + KYUUID + "%'";
	List<XwKylwb> list = xwKylwbDao.hqlQuery(hql);
