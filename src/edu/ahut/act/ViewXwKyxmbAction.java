...
public class ViewXwKyxmbAction extends ActionSupport{
	private static final long serialVersionUID = 4688235193882061219L;
	static private String filter = null;
	private List<?> datas;
	private ViewXwKyxmbService viewXwKyxmbService;
	...
	private List<?> zydm;
	private List<?> zymc;
	public ViewXwKyxmbAction(){
		viewXwKyxmbService = (ViewXwKyxmbService) SpringContextUtil.getBean("ViewXwKyxmbServiceImpl");
	}
	...
	public static void setFilter(String filter) {
		ViewXwKyxmbAction.filter = filter;
	}
	...
	public ViewXwKyxmbService getViewXwKyxmbService() {
		return viewXwKyxmbService;
	}

	public void setViewXwKyxmbService(ViewXwKyxmbService viewXwKyxmbService) {
		this.viewXwKyxmbService = viewXwKyxmbService;
	}
...
//		System.out.println(filters + "filters");
		Page<ViewXwKyxmb> pageList = viewXwKyxmbService.pageQuery(startNo, pageSize, filters, orders);
	...
	public String GetKCMC(){
		try {
			List<?> list = viewXwKyxmbService.getAll();
	...
	public String GetZJJS(){
		try {
			...
			List<?> list = viewXwKyxmbService.getAll(filter,null);
			setResult(new JsonResult(list, list.size()));
			result.setSuccess(true);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public String toExcel(){
		...
		if(!excelParams.equals("")){
			...
			try {
				...
				List<?> tList = viewXwKyxmbService.Query(filters, order);
