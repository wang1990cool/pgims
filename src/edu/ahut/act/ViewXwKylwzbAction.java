...
public class ViewXwKylwzbAction extends ActionSupport{
	...
	public ViewXwKylwzbAction(){
		viewXwKylwzbService = (ViewXwKylwzbService) SpringContextUtil.getBean("ViewXwKylwzbServiceImpl");
	}
...
//		filter = "xh = '" + xh + "'";
		...
		Page<ViewXwKylwzb> pageList = viewXwKylwzbService.pageQuery(startNo, pageSize, filters, orders);
...
//		filter = "xh = '" + xh + "'";
	...
	public String Add(){
		...
		try {
			ViewXwKylwzb pyKck = (ViewXwKylwzb) JSONObject.toBean(json, ViewXwKylwzb.class);
			viewXwKylwzbService.add(pyKck);
			result.setSuccess(true);
		} catch (Exception e) {
			e.printStackTrace();
...
//			System.out.println(pyKck);
	...
	public String Del(){
		try {
			...
			viewXwKylwzbService.deleteByIds(ids);
			result.setSuccess(true);
		} catch (Exception e) {
			e.printStackTrace();
			result.setSuccess(false);
	...
	public String CheckByXh(){
		try {
			...
			boolean isExist = this.viewXwKylwzbService.checkIsExistByXh(xh);
	...
	public String toExcel(){
		...
		if(!excelParams.equals("")){
			...
			try {
				...
				List<?> tList = viewXwKylwzbService.Query(filters, order);
