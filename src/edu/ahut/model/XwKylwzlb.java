...
/**
 * XwKylwzlb entity. @author MyEclipse Persistence Tools
 */

public class XwKylwzlb implements java.io.Serializable {
	...
	/** minimal constructor */
	public XwKylwzlb(String xh, String zllxm, String zllx, String xn, String xq) {
		this.xh = xh;
		this.zllxm = zllxm;
		this.zllx = zllx;
		this.xn = xn;
	...
	/** full constructor */
	public XwKylwzlb(String xh, String zllxm, String zllx, String zlwj,
