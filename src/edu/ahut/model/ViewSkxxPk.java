...
/**
 * ViewSkxxPk entity. @author MyEclipse Persistence Tools
 */

public class ViewSkxxPk implements java.io.Serializable {

	
	private static final long serialVersionUID = 3322062243253254544L;
	private long id;
	private String kkkh;
	private String kch;
	private String xn;
	...
	private String zjjs;
	private String zkjsh;
	private String zkjs;
	private String syjsh;
	private String syjs;
	private String zt;
	private String bz;
	...
	/** minimal constructor */
	public ViewSkxxPk(long id, String kkkh, String kch, String xn,
			String xq) {
		this.id = id;
		this.kkkh = kkkh;
		this.kch = kch;
	...
	/** full constructor */
	public ViewSkxxPk(long id, String kkkh, String kch, String xn,
			String xq, Long jhrs, Long xkrs, Long yxrs, Long ksz, Long jsz,
			String qzz, String kkdwh, String kksj, String kkdd, String ggkbzm,
			String ztm, String kcmc, String ggkbz, Double kcxf, String xslxm,
			String xslx, Long mzxs, Long zxs, Long llxs, Long syxs,
			String pydwh, String pydw, String zydm, String zymc, String kkdw,
			String zjjsh, String zjjs, String zkjsh, String zkjs, String syjsh,
			String syjs, String zt, String bz, String sjzxapbz, String ddzxapbz) {
		this.id = id;
		this.kkkh = kkkh;
		this.kch = kch;
		this.xn = xn;
	...
	public String getZkjsh() {
		return this.zkjsh;
	}

	public void setZkjsh(String zkjsh) {
		this.zkjsh = zkjsh;
	}
	...
	public String getSyjsh() {
		return this.syjsh;
	}

	public void setSyjsh(String syjsh) {
		this.syjsh = syjsh;
	}
