...
/**
 * YxXsjbxxb entity. @author MyEclipse Persistence Tools
 */

public class YxXsjbxxb implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 7734939541298234779L;
	private String id;
	private String nj;
	private String zkzh;
	private String bmh;
	private String xh;
	private String sftms;
	...
	private String dzxx;
	private String ksly;
	private String bbydw;
	private String bbyzy;
	private String bkbyny;
	private String xlm;
	private String xl;
	private String xwm;
	private String xw;
	...
	/** minimal constructor */
	public YxXsjbxxb(String nj, String zkzh, String xh) {
		this.nj = nj;
		this.zkzh = zkzh;
		this.xh = xh;
	}
	...
	/** full constructor */
	public YxXsjbxxb(String nj, String zkzh, String bmh, String xh,
			String sftms, String sfyzy, String zsbh, String xm, Double zxf,
			Double dyxnxf, Double xz, Double jcf, Double zsf, Double tjf,
			Double yktf, Double ylbxf, Double hj, String lqxym, String lqxy,
			String lqzym, String lqzy, String bddd, String xmpy, String xb,
			String jgd, String hf, String zjlx, String sfzh, String csrq,
			String csd, String hkd, String hkdz, String dad, String dadw,
			String dadz, String dayb, String gzdw, String gzjl, String jcqk,
			String jtcy, String txdz, String txyb, String lxdh, String yddh,
			String dzxx, String ksly, String bbydw, String bbyzy,
			String bkbyny, String xlm, String xl, String xwm, String xw,
			String mz, String zzmm, String lqlb, String rxfsm, String rxfs,
			byte[] zp, String bdztm, String bz,String jgdm, String csdm,
			String hkdm,String dadm,String xslxm,String xslx) {
		this.nj = nj;
		this.zkzh = zkzh;
		this.bmh = bmh;
		this.xh = xh;
	...
	public String getSftms() {
		return this.sftms;
	}

	public void setSftms(String sftms) {
		this.sftms = sftms;
	}

	public String getSfyzy() {
		return this.sfyzy;
	}

	public void setSfyzy(String sfyzy) {
		this.sfyzy = sfyzy;
	}
	...
	public String getLqxym() {
		return this.lqxym;
	}

	public void setLqxym(String lqxym) {
		this.lqxym = lqxym;
	}
	...
	public String getDadw() {
		return this.dadw;
	}

	public void setDadw(String dadw) {
		this.dadw = dadw;
	}
	...
	public String getTxyb() {
		return this.txyb;
	}

	public void setTxyb(String txyb) {
		this.txyb = txyb;
	}
	...
	public String getBbydw() {
		return this.bbydw;
	}

	public void setBbydw(String bbydw) {
		this.bbydw = bbydw;
	}

	public String getBbyzy() {
		return this.bbyzy;
	}

	public void setBbyzy(String bbyzy) {
		this.bbyzy = bbyzy;
	}

	public String getBkbyny() {
		return this.bkbyny;
	}

	public void setBkbyny(String bkbyny) {
		this.bkbyny = bkbyny;
	}
	...
	public String getBdztm() {
		return this.bdztm;
	}

	public void setBdztm(String bdztm) {
		this.bdztm = bdztm;
	}
