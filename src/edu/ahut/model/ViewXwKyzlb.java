...
/**
 * ViewXwKyzlb entity. @author MyEclipse Persistence Tools
 */

public class ViewXwKyzlb implements java.io.Serializable {
	...
	/** minimal constructor */
	public ViewXwKyzlb(Long id, String xn, String xq, String xh, String cglxm,
			String cglx, String kyuuid, String zlmc, String fmr, Long brpm,
			String sqr, String sqh, String zlfbztm, String zlfbzt, String ztm,
			String zt, String zllxm, String zllx) {
		this.id = id;
		this.xn = xn;
		this.xq = xq;
		this.xh = xh;
	...
	/** full constructor */
	public ViewXwKyzlb(Long id, String xn, String xq, String xh, String cglxm,
			String cglx, String kyuuid, String fmlxm, String fmlx, String zlmc,
			String fmr, Long brpm, String sqr, String sqh, String sqggr,
			String zlfbztm, String zlfbzt, String lrrgh, String lrr,
			String lrip, Date lrsj, String ztm, String zt, String bz,
			String shrgh, String shr, Date shsj, String shyj, String ship,
			String zsrgh, String zsr, Date zssj, String zsyj, String zsip,
			String shjgm, String shjg, String zllxm, String zllx, String zlwj,
			String zlwjmc, String zlwjdz, Date zlscsj, String zlscr,
			String zlscip, String zttm, String ztt, String xm, String xslxm,
			String xslx, String sznj, String fyh, String fymc, String zydm,
			String zymc, String pyccm, String pycc, String dsh, String dsxm) {
		this.id = id;
		this.xn = xn;
		this.xq = xq;
		this.xh = xh;
