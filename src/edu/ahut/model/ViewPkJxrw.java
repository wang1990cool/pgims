...
/**
 * ViewPkJxrw entity. @author MyEclipse Persistence Tools
 */

public class ViewPkJxrw implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -1010272021897694493L;
	private Long id;
	private String xn;
	private String xq;
	...
	/** minimal constructor */
	public ViewPkJxrw(Long id) {
		this.id = id;
	}

	/** full constructor */
	public ViewPkJxrw(Long id, String xn, String xq, String pydwh,
			String pydw, String zydm, String zymc, String kkkh, String kch,
			String kcmc, String kclbm, String kclb, String ggkbzm,
			String ggkbz, String jsbh, String jsmc, String zjjsh, String zjjs,
			String dszbzm, String dszbz, String kcsjm, String kcsj,
			String kczs, String kcjc, String pkztm, String czrzh, String czr,
			Timestamp czsj, String sjzxapbz, String ddzxapbz, String kksj,
			String kkdwh, String kkdw, String ctid, String zkjsh, String zkjs,
			Long zxs, Long mzxs, Double kcxf) {
		this.id = id;
		this.xn = xn;
		this.xq = xq;
		this.pydwh = pydwh;
