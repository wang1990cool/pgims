...
/**
 * XwKyjlzlb entity. @author MyEclipse Persistence Tools
 */

public class XwKyjlzlb implements java.io.Serializable {
	...
	/** minimal constructor */
	public XwKyjlzlb(String xh, String zllxm, String zllx, String xn, String xq) {
		this.xh = xh;
		this.zllxm = zllxm;
		this.zllx = zllx;
		this.xn = xn;
	...
	/** full constructor */
	public XwKyjlzlb(String xh, String zllxm, String zllx, String zlwj,
