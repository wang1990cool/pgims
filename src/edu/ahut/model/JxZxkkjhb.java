...
/**
 * JxZxkkjhb entity. @author MyEclipse Persistence Tools
 */

public class JxZxkkjhb implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -92925472750516968L;
	private long id;
	...
	private String kcsx;
	private Double kcxf;
	private String kcxslxm;
	private String kcxslx;
	private Double zxs;
	private Double llxs;
	private Double syxs;
	...
	/** minimal constructor */
	public JxZxkkjhb(long id) {
		this.id = id;
	}

	/** full constructor */
	public JxZxkkjhb(long id, String kkjhh, String xn, String xq,
			String xslxm, String xslx, String nj, String pydwh, String pydw,
			String xkzym, String xkzy, String bbh, String pyfah, String pyfa,
			String pyfsm, String pyfs, String kch, String kcmc, String ggkbzm,
			String ggkbz, String kclbm, String kclb, String kcxzm, String kcxz,
			String kcsxm, String kcsx, Double kcxf, String kcxslxm,
			String kcxslx, Double zxs, Double llxs, Double syxs, Integer jhrs,
			Short ksz, Short jsz, String qzz, String kkdwh, String kkdw,
			String bz) {
		this.id = id;
		this.kkjhh = kkjhh;
		this.xn = xn;
	...
	public String getXkzym() {
		return this.xkzym;
	}

	public void setXkzym(String xkzym) {
		this.xkzym = xkzym;
	}
	...
	public String getKcxslxm() {
		return this.kcxslxm;
	}

	public void setKcxslxm(String kcxslxm) {
		this.kcxslxm = kcxslxm;
	}

	public String getKcxslx() {
		return this.kcxslx;
	}

	public void setKcxslx(String kcxslx) {
		this.kcxslx = kcxslx;
	}
	...
	public void setJhrs(Integer jhrs) {
		this.jhrs = jhrs;
	}
